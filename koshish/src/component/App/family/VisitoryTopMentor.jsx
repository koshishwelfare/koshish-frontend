...
const VisitoryTopMentor = () => {
  ...
  return (
    <div className="app-section pt-2 text-center">
      <Helmet>
        <title>Visionary - Koshish</title>
        <meta name="description" content="Meet the visionary mentors leading Koshish's mission." />
        <meta name="keywords" content="Koshish, Visionary, Mentors" />
      ...
      <SectionIntro
        title="Our Visionary Mentors"
        description="Meet the top mentors who shape Koshish's vision and inspire our community."
      />
...
export default VisitoryTopMentor;
